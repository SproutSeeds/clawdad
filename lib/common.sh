...
CLAWDAD_CODEX_TURN_TIMEOUT_MS="${CLAWDAD_CODEX_TURN_TIMEOUT_MS:-0}"
CLAWDAD_CODEX_TURN_IDLE_TIMEOUT_MS="${CLAWDAD_CODEX_TURN_IDLE_TIMEOUT_MS:-0}"
CLAWDAD_CODEX_TOOL_IDLE_TIMEOUT_MS="${CLAWDAD_CODEX_TOOL_IDLE_TIMEOUT_MS:-0}"
CLAWDAD_CODEX_REQUEST_TIMEOUT_MS="${CLAWDAD_CODEX_REQUEST_TIMEOUT_MS:-120000}"
CLAWDAD_CODEX_RESUME_TIMEOUT_MS="${CLAWDAD_CODEX_RESUME_TIMEOUT_MS:-0}"
CLAWDAD_CODEX_LIVENESS_INTERVAL_MS="${CLAWDAD_CODEX_LIVENESS_INTERVAL_MS:-30000}"
CLAWDAD_CODEX_LIVENESS_PROBE_TIMEOUT_MS="${CLAWDAD_CODEX_LIVENESS_PROBE_TIMEOUT_MS:-10000}"
CLAWDAD_STALE_DISPATCH_TIMEOUT_MS="${CLAWDAD_STALE_DISPATCH_TIMEOUT_MS:-0}"
...
CLAWDAD_SERVER_BODY_LIMIT_BYTES="${CLAWDAD_SERVER_BODY_LIMIT_BYTES:-26214400}"
