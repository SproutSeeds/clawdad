...
CLAWDAD_CODEX_TURN_IDLE_TIMEOUT_MS="${CLAWDAD_CODEX_TURN_IDLE_TIMEOUT_MS:-300000}"
CLAWDAD_CODEX_TOOL_IDLE_TIMEOUT_MS="${CLAWDAD_CODEX_TOOL_IDLE_TIMEOUT_MS:-90000}"
