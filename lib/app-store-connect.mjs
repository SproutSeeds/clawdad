...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 98: Recreate one chosen Terminal window on a saved subscription account.",
      "• Waits quietly for active work to finish or stop, then preserves exact conversations and recoverable drafts.",
      "• Recreates only the chosen window; shows recovery progress and keeps other windows open. No automatic continuation or repeated /status commands.",
      "• Use Mac build 154 or later. Saved Terminal setups and pending delivery receipts remain protected.",
    ].join("\n"),
