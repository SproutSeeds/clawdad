...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 49: send iPhone screenshots and photos to your Terminal draft. Requires Mac build 60 for image attachments.",
      "• Copy an image on iPhone, open Remote Assist, select your Terminal draft, and tap Paste.",
      "• The photo button in the controls menu offers Photo Library and Browse Files. Choose up to eight images.",
      "• Images attach individually while preserving your draft. Press Enter yourself when you are ready to send.",
      "• If the selected input changes, images stay saved on Mac. Select the intended draft and tap Paste.",
      "• Compact progress, Pause, and Retry keep interrupted transfers recoverable while Remote Assist remains usable.",
      "• Files → Received Images keeps transferred images in your Mac's local library, separately from Documents.",
      "• Transfers connect directly when possible, with the existing budget-controlled relay available for restrictive networks. Image storage remains on your Mac.",
      "",
      "Check clipboard screenshot paste and multiple Photos selection on your physical iPhone. Try a draft with existing text, change tabs during an upload, and retry after a connection interruption.",
      "Verify each image appears once in the intended draft and nothing is submitted automatically. Check Received Images on both devices, and confirm dictation and Read Aloud still work.",
