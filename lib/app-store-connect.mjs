...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 35 Remote Assist response alerts:",
      "• Terminal Tabs mirrors the Mac Terminal alert when a background agent tab has activity waiting for you.",
      "• Unread tabs show a gold dot and Response ready label, with an unread count in the switcher header.",
      "• The Terminal control also shows a badge so waiting responses remain visible from the main Remote Assist menu.",
      "• The switcher refreshes while open, and focusing a tab clears its alert through Terminal's normal behavior.",
      "• ClawDad reads only Terminal's tab-alert accessibility metadata; it does not inspect terminal output.",
      "• The matching Mac beta 20 build 42 supplies the unread activity state.",
      "",
      "Test build 35:",
      "• Install Mac beta 20 build 42 and connect Remote Assist from the iPhone.",
      "• Leave a Codex Terminal tab in the background until its response returns.",
      "• Open Terminal Tabs and confirm the waiting tab shows the gold unread indicator and Response ready label.",
      "• Focus that tab, return to the switcher, and confirm Terminal's alert has cleared.",
