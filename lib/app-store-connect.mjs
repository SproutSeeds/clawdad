...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 48: reliable dictation after Read Aloud. Works with Mac build 55 or later.",
      "• Starting dictation cancels pending or playing audio so the microphone keeps recording.",
      "• Late audio parts and old playback callbacks cannot interrupt a new recording.",
      "• Voice previews wait until you finish dictation. Recording and playback share the same audio controls in the main app and Remote Assist.",
      "• Voice lists keep their position during background updates. Refreshing or saving preserves your current voice, language, and voice type filters.",
      "• Settings → Voice & Playback offers Kokoro (54 voices), Pocket TTS (26 voices), and Kitten TTS (8 voices).",
      "• Filter voices by language and voice type, preview a voice, then save it for the main app and Remote Assist.",
      "• Adjust speaking speed on models that support it. Each model remembers its selected voice.",
      "• Keep listening while switching Terminal tabs, leaving Remote Assist, or opening Settings. Pause and Stop stay available.",
      "• Playback begins as the first audio part arrives while the Mac generates the rest locally.",
      "",
      "Start reading a response, leave Remote Assist, then record a voice message. Repeat with dictation inside Remote Assist and check automatic insertion or clipboard fallback.",
      "Switch Terminal tabs and leave Remote Assist during preparation and playback. Check Pause, Resume, and Stop with a long response.",
      "Check voice quality and time to first sound on your physical iPhone. Dictation and Terminal picker gestures are preserved.",
