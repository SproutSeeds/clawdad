...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 26 Remote Assist controls:",
      "• A smaller controls button now hugs the lower-right corner of the remote desktop viewport.",
      "• The controls menu includes a nested Special Commands grid and returns to one button after each action.",
