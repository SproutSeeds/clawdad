...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 34 thread continuity and loading reliability:",
      "• Existing Codex CLI threads restore their full saved conversation instead of showing an empty mirrored-message view.",
      "• Recent threads across all projects sort by real message activity, so the latest sent or received turn rises to the top.",
      "• Project and thread selectors show a loading indicator while the selected Mac finishes refreshing its catalog.",
      "• Thread status appears once, and a genuinely empty thread uses one clear empty-state message.",
      "• Remote Assist keeps Paste visible and reads the iPhone clipboard only after you tap it.",
      "• The matching Mac beta 19 build 41 repairs false session quarantines and protects live state during isolated tests.",
      "",
      "Test build 34:",
      "• Install Mac beta 19 build 41 and open a Codex CLI thread that already contains messages.",
      "• Select that thread on iPhone and confirm its saved user and Codex messages appear once loading completes.",
      "• Send a turn and confirm that thread moves to the top of Recent across all projects after the response arrives.",
      "• Switch projects and verify a spinner appears until the refreshed project list is ready.",
      "• Open Remote Assist, copy text on iPhone, tap Paste, and confirm the text reaches the focused Mac control.",
