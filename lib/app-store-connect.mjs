...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 52: Close Terminal tabs from the Remote Assist picker. Use with Mac build 63.",
      "• Swipe left on a tab and choose Close. Confirm the directory, window, and tab position before closing.",
      "• If Terminal asks to end a running process, answer its confirmation from your iPhone.",
      "• Tabs disappear only after the Mac verifies closure. Repeated requests cannot close a neighboring tab.",
      "• The last tab clearly warns that its window will close. The picker follows Terminal’s next selected tab.",
      "• Scroll on the cards and hold the separate handle to reorder. Full swipe alone does not close a tab.",
      "",
      "Test Close and Cancel on a disposable tab, including two tabs with the same directory name.",
      "Check the running-process confirmation and closing the last tab of a separate window.",
