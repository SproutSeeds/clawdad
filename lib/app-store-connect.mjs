...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 76: Codex weekly allowance and alerts. Use with Mac build 86 or later.",
      "• Weekly percentage remaining and the exact reset day, date and local time appear on the main screen and in the Remote Assist menu.",
      "• Low allowance alerts arrive once at 5% and again at 0% per account and weekly cycle. Tap an alert to open the allowance. Unavailable and stale readings are labeled.",
      "• Mac build 86 repairs established Codex tabs being incorrectly classified as starting and working tabs appearing idle after app restarts.",
      "• Existing voice, Think aloud, transcription editing, images, drafts and native Terminal queue controls remain available.",
      "• Please check both allowance locations, notification permission and notification navigation, and Terminal input/queuing on your iPhone.",
    ].join("\n"),
