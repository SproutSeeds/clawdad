...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 81: Compact weekly allowance with details on demand. Use with Mac build 101 or later.",
      "• The main screen and Remote Assist show your actual percentage as weekly remaining, followed by a circled info icon.",
      "• Tap the info icon for the local reset date and time, last successful refresh, and an explanation of stale or unavailable readings. Usage refresh, alerts and research budget protections are preserved.",
      "• Verified on compact and large iPhone simulators, including large accessibility text and 44-point touch targets. Please confirm touch and VoiceOver behavior on your iPhone.",
    ].join("\n"),
