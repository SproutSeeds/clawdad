...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 45: smooth Terminal picker scrolling and dedicated reorder handles. Use with Mac build 52.",
      "• Swipe across any Terminal card to scroll. Tap a card to focus that tab on your Mac.",
      "• Hold the three-line handle to rearrange a tab within its window, with a larger touch area and clearer spacing.",
      "• Drag near the list's edge to scroll while reordering. Cancelling or releasing in place resumes refresh immediately.",
      "• Physical window groups, directory labels and confirmed Mac tab order are preserved.",
      "• Remote Assist retains the main app's high-quality voice and inline dictation.",
      "",
      "Please flick through a long tab list with your thumb over the left, middle and right of the cards.",
      "Check tapping, handle spacing, holding to reorder, edge scrolling and cancelling a drag on your iPhone.",
