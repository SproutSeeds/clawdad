...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 87: Compact workspace controls.",
      "• Main Workspace now sits to the right of weekly allowance on the home screen, freeing space for your project and message.",
      "• Both controls retain their tap targets. Accessibility text sizes keep a readable stacked layout.",
      "• Weekly allowance details, refresh, alerts and workspace behavior are unchanged.",
    ].join("\n"),
