...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 84: Longer Assistant chat messages. Use with Mac build 119 or later.",
      "• Send up to 131,072 UTF-8 bytes (128 KiB) in one message, including messages with images. Model context capacity remains separate.",
      "• Oversize drafts stay intact with a clear explanation. Unprocessed messages remain recoverable, with their text and images.",
      "• Long responses retain their full text. Unchanged history refreshes efficiently while calls stay connected.",
      "• Please verify a large paste, save/reopen, attached image, Copy and playback on your physical iPhone.",
    ].join("\n"),
