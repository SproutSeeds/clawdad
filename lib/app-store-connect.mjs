...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 40 Remote Assist reliability and local Files:",
      "• Terminal selection remains responsive during refresh and follows the Mac's tab order.",
      "• Drag a supported tab's handle within its window to move the existing tab on the Mac.",
      "• Remote Assist Read Aloud speaks the selected tab's latest completed response on iPhone.",
      "• Use on Mac reports whether dictation was inserted, copied, or sent as a paste request; retrying preserves the draft.",
      "• Files keeps finished deliverables in one local Mac library, with search, projects, formats, versions, pinning and archive.",
      "• Download a verified copy to iPhone, preview offline, and export through Share to Save to Files.",
      "• Files transfers directly between devices. Networks that block direct connections show a connection error; paid relay downloads remain disabled.",
      "",
      "Test build 40 with Mac build 48:",
      "• Switch tabs rapidly, reorder using a handle, and compare the actual Mac tab strip after each move.",
      "• Read two different Terminal responses and test Pause, Resume, Stop and tab changes.",
      "• Dictate, use the text in a focused Mac input, then try with no editable input and paste from the clipboard.",
      "• Add a finished file on Mac, find it on iPhone, interrupt and resume a download, preview offline, and save to Files.",
