...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 71: Assistant mute preserves your words and faster word-based turn ending. Use with Mac build 83 or later.",
      "• Tapping mute immediately stops new microphone audio while already captured speech finishes transcribing and sends. Quick mute/unmute cycles preserve the current thought, typed drafts and images.",
      "• Automatic replies begin after two seconds without newly transcribed words. Repeated partial text and room noise do not reset the word timer; pending final transcription preserves the last words.",
      "• Think aloud keeps the turn open until Send, which remains available while muted. Calls stay connected, replies can finish playing, and reconnects keep one delivery identity.",
      "• Spoken mute/unmute remains removed. The microphone is fully off while muted; audio captured after mute is excluded and never replayed on unmute.",
      "• Please verify speak-then-mute, short mute/unmute cycles, final words, audible replies and microphone privacy indication on your iPhone.",
    ].join("\n"),
