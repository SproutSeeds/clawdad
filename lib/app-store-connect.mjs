...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 30 Remote Assist and composer controls:",
      "• Command-T in Special Commands opens a new tab in the active Mac app.",
      "• The new scissors control copies the exact composer draft, clears it only after clipboard success, and returns focus to the editor.",
      "• Update the paired Mac to ClawDad beta 8 build 25 before testing Command-T.",
      "",
      ...
      "• Enable Remote Assist and test landscape, keyboard, Enter, clipboard, Command-T, and Command-Tab.",
