...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 47: steadier voice picking. Use with Mac build 56 and the updated local speech service.",
      ...
      "",
      "Please compare voice previews, save a voice, reopen Settings, then read a response in the main app and Remote Assist.",
