...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 55: Agent response notifications. Use with Mac build 70 or later.",
      ...
      "Keep ClawDad running on the Mac. Test an agent response while the iPhone is locked, tap the alert, and confirm the correct conversation opens. Physical push delivery acceptance remains pending.",
