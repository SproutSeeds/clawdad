...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 88: Named Terminal snapshots and guarded window closing.",
      "• Save multiple named window setups. Update captures exactly the current tabs and keeps a recoverable previous version.",
      "• Restore exact conversations with their latest history. Review missing identities and choose how to reuse an existing window.",
      "• Swipe a window row to Close window, or use its accessible action. Save and close verifies identities and drafts first.",
      "• Requires Mac build 133 or later. Existing snapshots and legacy recovery data stay preserved.",
    ].join("\n"),
