...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 31 native host and Remote Assist improvements:",
      "• Choose which connected Mac display to view from the compact Remote Assist menu.",
      "• Display changes preserve one secure session and pause input until the new screen is ready.",
      "• CMD+T is available in Special Commands, and Cut is available in message composers.",
      "• The paired Mac now owns one bundled messaging runtime for consistent thread delivery.",
      "",
      ...
      "• Enable Remote Assist and test every connected display, landscape, keyboard, CMD+T, Enter, and clipboard in both directions.",
