...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 70: Assistant voice reliability and native Terminal draft editing. Use with Mac build 82 or later.",
      "• Spoken mute/unmute and their always-on command detector have been removed. Use the microphone icon to fully mute or unmute; the call stays connected. Old voice-command preferences no longer affect calls.",
      "• Live words stay visible while final transcription is pending. Unexpected capture failures preserve already displayed unsent words separately for review, keeping typed drafts and images intact.",
      "• Microphone recovery now handles repeated audio-route changes in long calls. Four-second turn ending, Think aloud and manual Send remain available. Nothing recorded while fully muted is replayed on unmute.",
      "• Expanded multiline Terminal drafts can be cleared or replaced. Collapsed text uses explicitly authorized whole-draft editing with fresh native targeting and verified results, without Enter or Tab. Attachments, clipped inputs and unrelated drafts stay protected.",
      "• Please verify microphone privacy indication, pause/send/resume, audio-route changes and audible playback on your iPhone. Broader Remote Assist layout is unchanged.",
    ].join("\n"),
