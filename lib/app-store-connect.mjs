...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 86: Custom Special Keys. Use with Mac build 125 or later.",
      "• Shift + Left Arrow is included in Remote Assist Special Keys.",
      "• Tap Edit to add labeled key combinations, change existing ones, restore built-in defaults, or delete your own.",
      "• Choose a key plus Shift, Control, Option and Command. Combinations stay saved on this iPhone; saving does not send them.",
      "• Please verify selection, custom combinations, editing and reopening Special Keys on your physical iPhone.",
    ].join("\n"),
