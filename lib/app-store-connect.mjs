...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 94: Shared Terminal setup review.",
      "• Main Workspace keeps the saved lineup you reviewed when another device updates it.",
      "• Review the latest version explicitly before restoring a changed setup.",
      "• Mac build 144 adds visible Save Terminal Setup and Open Saved Setup controls using the same library.",
      "• Preserves message playback, speech boost, drafts and the notification repair from build 93.",
    ].join("\n"),
