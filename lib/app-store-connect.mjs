...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 27 Remote Assist controls:",
      "• The expanded controls stay compact at the lower-right instead of stretching across the remote desktop.",
      "• The main menu and nested Special Commands grid each use a bounded width, with an explicit Back control.",
      "• Send Control-C, Control-J, Escape, Tab, arrow keys, Control-L, or Command-Tab to the paired Mac.",
      "",
