...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 82: Assistant model settings, message playback and jump to latest. Use with Mac build 102 or later.",
      "• Settings → Assistant shows authenticated models and supported reasoning efforts for the main Assistant, research defaults and each configured supervisor. Changes apply to subsequent work and preserve objectives, paused states and weekly budgets.",
      "• Read either participant’s message with the speaker beside Copy. Stop or switch playback while preserving calls and manual mute.",
      "• A down arrow above the composer returns to the latest message while older history stays in place during incoming responses.",
      "• Please confirm physical iPhone playback, microphone echo suppression, VoiceOver and comfortable touch behavior at your preferred text size.",
    ].join("\n"),
