...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 43: grouped Terminal windows and shared Remote Assist voice. Use with Mac build 51.",
      "• Each physical Terminal window has an expandable group, with its tabs listed in left-to-right order.",
      "• Duplicate tab titles and directories stay separate. Selecting a tab preserves the list order.",
      "• Drag a row's handle to reorder tabs within that Terminal window. Window expansion is remembered in the switcher.",
      "• Remote Assist uses the main app's speech model and voice. Preparing voice stays inline; playback starts automatically.",
      "• Highlighted text takes priority, then the focused tab's latest completed answer. Stop cancels waiting or playback.",
      "",
      "Please compare the picker with two actual Terminal windows, including many tabs and duplicate names.",
      "Check tab reordering from both devices, then compare the voice in Remote Assist with the main app.",
      "Test slow speech preparation, Stop, retry and reconnection. Dictation remains inline with automatic insertion or clipboard fallback.",
