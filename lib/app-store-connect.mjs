...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 103: Clear account activation progress and automatic Mac startup recovery.",
      "• See whether activation is waiting for the Mac, waiting for app work, or needs recovery.",
      "• The active account comes from the running Mac server. Connection loss is shown explicitly, and reconnecting refreshes the account state.",
      "• Mac build 163 automatically resumes activation after its process reader becomes available. Existing conversations, drafts, and independent Terminal sessions are preserved.",
    ].join("\n"),
