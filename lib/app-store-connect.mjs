...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 73: Think aloud on the call bar, an icon glossary, and image-only Assistant messages. Use with Mac build 84 or later.",
      "• Tap infinity on the persistent call bar to hold a speaking turn. A steady light, outline and checkmark show it is on. Tap again for the existing two-second word timer.",
      "• Send a held voice turn from the empty Assistant chat composer, including while muted. Typed text and images are sent separately and preserved until accepted.",
      "• Settings now includes an Icon glossary with names, actions and states for Remote Assist and Assistant controls.",
      "• Send a picture without a caption. The Assistant receives the actual image and can refer to it later in the conversation. Failed uploads retain the original draft and delivery ID.",
      "• Please verify infinity across Terminal and chat, Send while muted, image-only messages and follow-up questions, larger text, and VoiceOver on your iPhone.",
    ].join("\n"),
