...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 38 Remote Assist Read Aloud:",
      "• Choose a Terminal tab, then open … and tap the speaker to hear its latest completed Codex response.",
      "• See the source tab, completion time, and response text without leaving Remote Assist.",
      "• Pause, resume, stop, and copy the response to iPhone. A compact player stays available after closing the panel.",
      "• Read selected text supports other agents and text selected on the Mac.",
      "• A new response in progress is labeled; the previous answer plays only when requested.",
      "• Switching tabs cancels pending reading and stops the previous tab's audio.",
      "• Includes Remote Assist dictation and the All Projects refresh improvements.",
      "",
      "Test build 38 with Mac build 46:",
      "• Read two different Terminal tabs with long Codex conversations. Confirm each speaks only its newest completed answer.",
      "• Switch tabs while audio is preparing and verify the old answer does not start playing.",
      "• Test Pause, Resume, Stop, Back, and Copy text to iPhone.",
      "• Select text on the Mac and choose Read selected text. Verify the exact selection is spoken.",
