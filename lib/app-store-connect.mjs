...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 51: Quick Chat presets and compact Remote Assist controls. Use with Mac build 62.",
      "• Open Quick Chat from the speech-bubble icon. Tap a preset to type its exact text and press Enter immediately.",
      "• Includes pwd, ls, cd .., Continue implementation, and Discuss next steps.",
      "• Add, edit, or delete your own presets with Edit. Presets stay locally on your iPhone.",
      "• A delayed receipt retries the same operation without sending the preset twice. A changed input is never substituted for the captured target.",
      "• The constant Secure session header and floating Mac status panel are removed. Stop Remote Assist is in the ClawDad application menu while connected.",
      "",
      "Focus an input on the Mac, open Remote Assist controls, choose Quick Chat, and tap a preset once.",
      "Check editing and saving a custom preset, then close and reopen the app to verify it persists.",
      "Existing inline dictation, speaker playback, photo transfers, and shared Files remain available.",
