...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 80: More comfortable Think aloud button spacing. Use with Mac build 101 or later.",
      "• The visible circle and infinity symbol are proportionally smaller within the same 44-point touch target.",
      "• Keeps the active glow, selected-state checkmark, accessibility labels and existing Think aloud behavior across the shared call bar.",
      "• Enabled and disabled states were visually checked on compact and large iPhone simulators. Please confirm the spacing and touch behavior on your iPhone.",
    ].join("\n"),
