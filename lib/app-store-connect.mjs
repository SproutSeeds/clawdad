...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 78: Shared and per-supervisor weekly allowance controls. Use with Mac build 93 or later.",
      "• Open Research autonomy → Weekly allowance to set the shared stopping default or a custom limit for that exact supervisor. You can type a percentage or use the stepper.",
      "• Percentages mean weekly allowance REMAINING: 20% pauses new work at 20%; 0% allows using the remaining allowance until exhausted. All work shares the same account pool.",
      "• Custom overrides last through the current weekly cycle. Resets never clear a pause. Running tasks may consume more after new automatic work stops. General 5% and 0% alerts remain available.",
      "• Ask the main Assistant to change these settings on your explicit instruction. You can also save a research setup with autonomy off before choosing a limit and starting it.",
      "• Installation leaves existing settings and supervisors unchanged. Please check percentage entry, confirmations, VoiceOver and navigation during a call on your iPhone.",
    ].join("\n"),
