...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 85: Consistent Assistant speech. Use with Mac build 120 or later.",
      "• Automatic replies and message readback keep your selected voice throughout the message.",
      "• Temporary failures retry briefly, then pause with Resume speech and Stop. Resume keeps completed audio and your saved place.",
      "• Recovery preserves cached chunks, microphone mute, Think aloud, and the connected conversation.",
      "• Please check long-message voice consistency, interruption recovery and Bluetooth playback on your physical iPhone.",
    ].join("\n"),
