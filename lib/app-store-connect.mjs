...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 91: Per-device speech boost.",
      "• Adjust speech boost in Settings while retaining your chosen voice.",
      "• Settings persist on each device and apply to Assistant responses and message readback.",
      "• Requires Mac build 137 or later for Assistant speech-boost controls.",
    ].join("\n"),
