...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 32 Remote Assist Terminal tab switcher:",
      "• Open Terminal Tabs from the compact Remote Assist menu.",
      "• See the Terminal windows and tabs reported by the paired Mac, including the current and busy states.",
      "• Choose a row to focus that exact Terminal window and tab.",
      "• Use Back and Refresh without leaving the active Remote Assist session.",
      "• The existing Screens selector, CMD+T, keyboard, clipboard, and composer Cut controls remain available.",
      "",
      ...
      "• Enable Remote Assist, switch between Terminal tabs and connected displays, then test landscape, keyboard, CMD+T, Enter, and clipboard in both directions.",
