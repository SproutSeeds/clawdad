...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 104: Shared subscription intelligence and saved agent access.",
      "• Choose computer-wide agent permissions once in Settings: full access, project folders or read only, with automatic safety review or Ask me.",
      "• Assistant and manual app-server requests use the computer’s selected ChatGPT subscription and saved native tool permissions.",
      "• The companion Mac release moves Assistant and supervisor reviews to the app server, preserves existing conversations, and adds request-specific native computer tools. Use Computer default in the message composer to inherit saved access.",
    ].join("\n"),
