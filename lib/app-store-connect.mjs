...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 83: Save and restore your Main Terminal workspace. Use with Mac build 112 or later.",
      "• Save the intended Terminal window, then use Restore Main Workspace from the main screen or Remote Assist Terminal picker. Existing conversations and drafts stay in place; missing tabs resume their exact saved conversation.",
      "• View recoverable draft snapshots, explicitly remove saved projects, and check per-tab progress when a drive, startup decision or ownership review is needed.",
      "• The Mac also fixes submitting an already-present collapsed Codex draft, with separate evidence for Enter dispatch and the accepted conversation turn.",
      "• Please confirm physical iPhone navigation, VoiceOver and touch behavior. Real reboot, logout and complete Terminal shutdown recovery require a separately coordinated check.",
    ].join("\n"),
