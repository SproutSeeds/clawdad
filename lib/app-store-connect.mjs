...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 97: Leave selected Terminal sessions unchanged during account switching.",
      "• See Waiting, Verifying, Switched and Skipped status for each session.",
      "• Skipped tabs keep their work and may remain on a different account; the choice survives reconnects and restarts.",
      "• Use Mac build 152 or later. Existing drafts, queues and saved Terminal setups remain protected.",
    ].join("\n"),
