...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 29 Remote Assist keyboard behavior:",
      "• A normal tap on the remote desktop now closes the iPhone keyboard and still sends the click to the Mac.",
      "• Pending text is delivered before the click so it stays in the field where it was typed.",
      "• The lower-right controls remain reachable above the keyboard and dismiss it before opening.",
      "",
