...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 63: Open Assistant as a text conversation, attach images, and keep unsent drafts across navigation and app restarts. Use with Mac build 74 or later.",
      "• Tap the message bubbles on the home screen or in Remote Assist to chat. The headset remains an explicit voice call option.",
      "• Select up to four photos, preview or remove them, then send the actual images with your message for the Assistant to inspect.",
      "• Unsent text and photos stay saved locally for the selected Mac until a confirmed send or explicit deletion. Interrupted uploads resume and uncertain sends retry without duplication.",
