...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 89: Durable Assistant work and exact reply notifications.",
      "• Accepted Assistant messages keep processing on your awake Mac after you end the call or leave the iPhone app.",
      "• Pending text, images and displayed voice words remain recoverable with their original delivery IDs.",
      "• Assistant replied notifications open the exact saved reply and read it aloud, with Pause and Stop and no microphone activation.",
      "• Requires Mac build 135 or later. Long work uses progress monitoring; cancellation is separate from ending a call.",
    ].join("\n"),
