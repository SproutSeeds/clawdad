...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 54: One-tap Assistant calls. Use with Mac build 68.",
      ...
      "Test starting and ending repeated calls, typed follow-ups, interruption, and a harmless task in a disposable agent tab. Physical iPhone-to-Terminal acceptance remains pending.",
