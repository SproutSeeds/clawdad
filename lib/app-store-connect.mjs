...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 50: one-tap Remote Assist reading and reliable PDF preview and Save to Files. Compatible with Mac build 60.",
      "• One speaker tap continues through a slow first Terminal lookup and starts the audio automatically.",
      "• Temporary audio-start failures retry using the received audio. Stop cancels pending playback.",
      "• Highlighted text still takes priority. A retry never follows a changed Terminal tab to a different answer.",
      "• File preview, Save to Files, Share, and Remove Download have independent tap targets.",
      "• Save to Files opens the system document exporter and confirms completed saves. Cancel preserves the download.",
      "• Verified file copies stay available throughout preview and sharing. On My iPhone → ClawDad is available for local exports.",
      "",
      "Open the shared Files folder in Remote Assist, download ClawDad Shared Files Test, and verify the text in Preview.",
      "Choose Save to Files, save locally, then open that PDF from the Files app. Also check Share and cancellation preserve the download.",
      "Tap the speaker once after connecting or switching Terminal tabs. Check playback starts, continues across navigation, and Stop stays effective.",
