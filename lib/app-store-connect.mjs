...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 96: Clearer account selection and switch progress.",
      "• Choose one saved account from a dropdown, with one set of account controls.",
      "• See immediate switch feedback, waiting reasons and automatic receipt recovery after a dropped connection.",
