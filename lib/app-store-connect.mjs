...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 36 thread refresh:",
      "• All Projects checks for recent thread activity automatically every 15 seconds while connected.",
      "• Opening All or tapping Refresh requests fresh activity from the Mac.",
      "• Opening a newly discovered thread preserves its selection while the Mac synchronizes its history.",
      "• Delayed catalog and history responses no longer replace newer results when paired with Mac build 43.",
      "• Interrupted refreshes retry automatically, and expanded conversations keep their history window.",
      "• Routine updates transfer only the latest thread summaries.",
      "",
      "Test build 36 with Mac build 43:",
      "• Leave All Projects open while starting or continuing a thread in another project on the Mac; confirm it appears within 30 seconds.",
      "• Open a new native thread and confirm the selected conversation stays correct as its history loads.",
      "• Switch projects during refresh, then background and reopen the phone app; confirm activity resumes without changing your selection.",
