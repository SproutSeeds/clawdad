...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      ...
      "• The matching Mac beta 12 setup assistant includes managed Node and ORP, official Codex installation, ChatGPT sign-in, project-home selection, and pairing guidance.",
      "",
      "Test build 33:",
      "• Pair the iPhone with two Macs running beta 12 build 34.",
