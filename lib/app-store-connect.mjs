...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 69: Optional hands-free Assistant mute and unmute. Use with Mac build 81 or later.",
      "• Open Assistant → Voice controls to opt in to on-device English (US) commands. Say ClawDad, mute. Optional voice reactivation lets ClawDad, unmute resume the same call; it is off by default. Please mute / unmute are separate optional phrases.",
      "• Voice-muted audio stays in transient on-device command detection, with no online fallback or delivery to your Mac. Full microphone off remains one tap away and disables voice reactivation. The manual mute button always fully stops capture.",
      "• Muting discards unsent voice input and pending transcription, preserving typed drafts and images. Fresh audio begins after unmuting. Confirmation uses a brief haptic after the transition.",
      "• Voice commands pause during replies and keep the screen awake while listening. Going into the background or locking the phone fully mutes; return and unmute manually. Extra battery use and physical microphone/haptic performance need iPhone verification.",
      "• Four-second turn ending, Think aloud, text/image chat, saved drafts, contact links, recovery and native Terminal tools remain available.",
      "Please check repeated voice/manual cycles, long foreground calls, private speech while muted, no replay after unmute, background/lock and route interruptions, real recognition latency and haptics. Automated and simulator checks do not certify microphone privacy on a physical iPhone.",
    ].join("\n"),
