...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 37 Remote Assist dictation:",
      "• Open the … controls and tap the microphone beside the keyboard.",
      "• Record, stop, then review and edit the transcript before using it.",
      "• Use on Mac saves the text to the Mac clipboard and inserts it when a text input is focused.",
      "• With no suitable input focused, the transcript stays on the Mac clipboard for later pasting.",
      "• Copy to iPhone is available for pasting into other phone apps.",
      "• Drafts survive closing the panel and connection interruptions; failed transcriptions can be retried.",
      "• Includes the All Projects refresh improvements from build 36.",
      "",
      "Test build 37 with Mac build 45:",
      "• Focus a Terminal or browser text field, dictate, edit, and use the transcript. Confirm Enter remains a separate action.",
      "• Click an empty area with no text input focused, then use a transcript. Confirm Copied to clipboard and paste it later.",
      "• Copy a transcript to iPhone, close and reopen dictation, and confirm the edited draft remains.",
      "• Interrupt the connection during transcription and retry the saved recording after reconnecting.",
