...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 46: local voice selection and continuous playback. Use with Mac build 55 and the updated local speech service. Mac build 55 fixes the voice Settings connection error.",
