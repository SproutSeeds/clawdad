...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 53: Assistant inside ClawDad. Use with Mac build 66.",
      "• Open Assistant from the main app or the headset in Remote Assist. Talk or type in one persistent conversation.",
      "• Speech uses your selected local Mac STT and TTS models and voice. A visible Codex Terminal session coordinates work.",
      ...
      "",
      "On first use, complete any Codex startup prompt in the Assistant Terminal tab on the Mac.",
      "Test a voice conversation, interruption, background playback, and a harmless task in a disposable agent tab. Physical iPhone-to-Terminal acceptance remains pending.",
