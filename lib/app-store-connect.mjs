...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 99: Repair selected-window account switching and clarify progress.",
      "• Verifies cold Terminal tabs and preserves the current lineup, exact conversations and recoverable drafts.",
      ...
      "• Stops with a specific reason when work or input needs attention. Use Mac build 155 or later.",
    ].join("\n"),
