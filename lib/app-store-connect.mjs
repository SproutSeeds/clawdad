...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 25 Remote Assist update:",
      "• One compact controls button now preserves the remote desktop viewport.",
      "• Exit, Enter, clipboard, keyboard, and zoom reset open together and collapse after each action.",
      "",
