...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 95: Subscription account controls.",
      "• View saved Codex accounts and follow a deliberate switch or recovery from iPhone.",
      "• Keep account setup and browser sign-in visible, with accessible controls on small screens and at larger text sizes.",
      "• Existing work, drafts and saved Terminal setups remain protected during account transitions.",
    ].join("\n"),
