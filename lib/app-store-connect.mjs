...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 79: Assistant destinations and speech recovery. Use with Mac build 101 or later.",
      "• The Terminal/claw button chooses the work destination. Explicit conversation instructions can target another thread. Switching preserves existing work and drafts.",
      "• Assistant tools can discover, read, create, draft, send images to and queue work in exact ClawDad app-server threads. Terminal-owned sessions retain native Terminal control.",
      "• Local speech recovers after temporary service failures. Device speech is available during recovery, and subsequent replies retry your selected primary voice.",
      "• Keeps manual mute, Think aloud, voice editing, images, selectable messages and research allowance controls.",
      "• Please check physical iPhone audio, VoiceOver and destination switching during a call. Simulator checks do not verify audible phone playback.",
    ].join("\n"),
