...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 102: Glass account picker with app-only activation. Terminal stays independent.",
      "• Preview each saved subscription’s allowance and reset time in one email menu. Activate separately for this Mac’s ClawDad projects, Assistant and supervisor reviews.",
      "• Shared selection across iPhone and Mac. Accepted app work retains its owner and account; drafts and histories are preserved.",
      "• Terminal sign-in and windows remain independent. Requires Mac build 161 or later.",
    ].join("\n"),
