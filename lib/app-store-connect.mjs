...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 28 Read Aloud playback:",
      "• Locally generated speech now starts with a valid iPhone playback session.",
      "• Message and Codex-response audio continues to support the iPhone's normal AirPlay and Bluetooth routes.",
      "• Build 27's compact Remote Assist controls and Special Commands remain included.",
      "",
