...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 68: Assistant drafts, native queue repair, and readable chat. Use with Mac build 80 or later.",
      "• Insert a draft into an exact working Terminal tab immediately, without Enter or Tab. Existing drafts require explicit replacement permission.",
      "• Queue an authorized follow-up with Tab once. The Mac verifies the running agent that owns the conversation, preserves other drafts, and tracks that request through its own completion.",
      "• Assistant chat hides diagnostic test and polling records, keeps readable task cards updated with their original requests and results, and adds quick-copy controls for messages.",
      "• Voice turns still send after four seconds without new words. Think aloud remains off by default and keeps listening through pauses until you tap Send.",
      "• Text chat, image attachments, saved drafts, contact links, and connection recovery remain available. Broader Remote Assist layout changes await your preference.",
      "Please verify busy-tab insertion and manual Tab, native queue order, chat copying and scrolling, image drafts after reopening, and natural voice pauses on your iPhone.",
    ].join("\n"),
