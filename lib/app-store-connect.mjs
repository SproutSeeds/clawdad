...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 44: Terminal switcher reliability repairs. Use with Mac build 52.",
      "• Stable physical window groups and directory names, with tabs listed in the Mac's left-to-right order.",
      "• Faster discovery and confirmed selection. Tap a highlighted row to reassert its selection on the Mac.",
      "• Failed or incomplete reads preserve the last good catalog. A surviving tab can be retried automatically.",
      "• Drag visible tab handles within a window. Cancelling a drag resumes refresh immediately.",
      "• Remote Assist retains the main app's high-quality speech model and voice, plus inline dictation.",
      "",
