...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 42: inline Remote Assist speech. Use with Mac build 50.",
      "• Tap the mic in the Remote Assist menu to record; tap Stop to transcribe and automatically insert into the remembered Mac input.",
      "• With no eligible input, text goes to the clipboard. The Paste icon uses that same new transcript.",
      "• Tap the speaker to read highlighted Mac text first, or the focused Terminal tab's latest completed Codex answer. Tap again to stop.",
      "• Both controls stay inline, with recording/loading feedback and no speech sheets.",
      "• Capability discovery retries after connecting; missing information no longer masquerades as an outdated Mac.",
      "",
      "Please test on your iPhone:",
      "• Record twice into the same input without closing the menu; confirm each transcript appears once and Enter stays separate.",
      "• Record with no input, choose a field, then use Paste. Try moving or closing the original target while recording.",
      "• Read highlighted text, clear the selection, then read the latest completed answer from two different Terminal tabs.",
      "• Reconnect Remote Assist and repeat. Check playback after dictation and with your usual headphones.",
