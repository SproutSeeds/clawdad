...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 77: Select message passages and opt into research autonomy. Use with Mac build 89 or later.",
      "• Long-press your messages or Assistant replies to select and copy a word, sentence or passage. The copy icon still copies the whole message.",
      "• Research autonomy is off by default. Open Assistant → Workspace → Research autonomy for an exact Terminal agent, enter an objective, scope and verification requirements, then explicitly enable it.",
      "• The separate supervisor reviews completed work and local evidence, keeps decision history and sends bounded continuations. Pause and Off leave running agent work intact.",
      "• At 20% weekly allowance, new autonomous work pauses across the account. Resets do not remove the pause. Further work requires a deliberate bounded override. General 5% and 0% alerts remain available.",
      "• Please check selection handles, contextual Copy, links and VoiceOver on your iPhone during a call. Test research controls only on a disposable thread with a limited objective.",
    ].join("\n"),
