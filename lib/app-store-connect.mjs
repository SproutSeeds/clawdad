...
export const appReleaseCatalog = Object.freeze({
  ...
  beta: Object.freeze({
    ...
    whatsNew: [
      "Build 74: Edit and clear an unsent Assistant voice transcription. Use with Mac build 84 or later.",
      "• Tap the pencil beside live transcription to correct its words. Capture and automatic sending pause immediately; Save edits keeps the correction held. Send explicitly or Resume listening when ready.",
      "• Tap the trash can for Clear this transcription? Clear discards that voice turn; Cancel keeps it held. Typed drafts, images and conversation history stay intact.",
      "• Late transcription cannot overwrite a correction or bring back cleared words. Held corrections survive leaving and reopening the conversation; the call stays connected.",
      "• Settings > Icon glossary explains both controls. The existing two-second word timer and infinity Think aloud mode remain available.",
      "• Please verify pencil and trash near the send deadline, pending transcription, Save then Send once, Clear/Cancel, muted and Think aloud modes, navigation, larger text and VoiceOver on your iPhone.",
    ].join("\n"),
