...
const controls = new Set(['research.enable','research.configure','research.start','research.pause','research.off','research.resume','research.restart','research.clear','research.steer','research.override']);
