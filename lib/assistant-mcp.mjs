    ...
    try {
      ...
      case 'tools/call': {
        ...
        if(name==='workspace')value=await request('/v1/assistant/state');
          ...
          value=await request('/v1/assistant/tool',{...payload,action,requestId:args.requestId||crypto.randomUUID(),...(diagnostic?{diagnostic:true}:{})});
