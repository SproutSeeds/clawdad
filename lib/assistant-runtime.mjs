...
export class AssistantRuntime {
  ...
  async command(request, {tool = false, supervisor = null, observationOnly = false} = {}) {
    ...
    return this.transaction(async () => {
      ...
      if(action==='mainworkspace.preview'&&args.windowId!==undefined&&!/^[a-f0-9]{64}$/.test(args.windowId))throw Error('Refresh and choose the exact window identity before reviewing');
