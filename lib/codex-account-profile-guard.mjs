...
export async function claimAccountProfile(home,{lease=acquireCodexDeliveryClaim,timeoutMs=5000}={}){
  ...
  if(!stat.isDirectory()||stat.isSymbolicLink()||await fs.realpath(home)!==home||stat.uid!==process.getuid()||stat.mode&0o077)
