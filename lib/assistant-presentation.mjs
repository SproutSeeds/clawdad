...
const taskActions = new Set(['terminal.send','terminal.queue','terminal.insert','terminal.clear','terminal.replace','terminal.native.type','appserver.send','appserver.queue','appserver.draft','appserver.clear','appserver.create','appserver.resume','appserver.restore']);
