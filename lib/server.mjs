...
async function runServe(argv) {
  ...
  const codexAccounts=new CodexAccounts({root:privateRuntimeRoots.accounts,usage:weeklyUsage,
    readWork:async()=>{
  ...
  codexAccounts.onActivated=selection=>assistantRuntime.research.accountActivated(selection);
