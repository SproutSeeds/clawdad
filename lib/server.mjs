    ...
    if (url.pathname.startsWith("/v1/files/")) {
      ...
      try {
        if (req.method === "GET" && url.pathname === "/v1/files/library") {
          json(res, 200, { ok: true, ...await library.list({ query: url.searchParams.get("query") || "", project: url.searchParams.get("project") || "", format: url.searchParams.get("format") || "", archived: url.searchParams.get("archived") === "true", pinned: url.searchParams.get("pinned") === "true", cursor: url.searchParams.get("cursor"), limit: url.searchParams.get("limit") }) });
