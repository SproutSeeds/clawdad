...
export class ResearchReviewRunner {
  constructor({root,binary='codex',resolveBinary=null,launch=spawn,timeoutMs=240_000,resolveAccountLaunch=null}) { Object.assign(this,{root,binary,resolveBinary,launch,timeoutMs,resolveAccountLaunch}); }
