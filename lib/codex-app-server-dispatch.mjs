...
function buildTurnParams(threadId, options) {
  const params = {
    ...
    input: [
      ...
      ...(Array.isArray(options.attachmentInputs) ? options.attachmentInputs : []),
    ],
...
async function waitForTurnCompletion(
  ...
  turnId,
  timeoutMs = 0,
  { onAgentText = null, idleTimeoutMs = 0, toolIdleTimeoutMs = 0 } = {},
) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const currentIdleLimit = () => {
      if (activeMcpToolCallIds.size > 0 && toolIdleTimeoutMs > 0) {
        return {
