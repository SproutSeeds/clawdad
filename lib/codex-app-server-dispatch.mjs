...
async function waitForServerRequestDecision(message, options) {
...
async function handleCodexServerRequest(client, message, options, eventRecorder) {
  ...
  if (automatic.handled) {
    client.respond(message.id, automatic.result);
  ...
  try {
    const result = await waitForServerRequestDecision(message, options);
