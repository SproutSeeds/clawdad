    ...
    ScrollView {
      LazyVStack(alignment: .leading, spacing: 20) {
        ...
        section("Assistant chat") {
          entry("speaker.wave.2", "Read message aloud", "Reads that user or Assistant message through your selected speech system. Starting another message stops the previous one. It sends no conversation turn.", "A selected stop icon marks the preparing or playing message. Tap it to stop. Playback temporarily blocks call microphone input and preserves manual mute and Think aloud.")
